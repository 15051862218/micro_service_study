package com.syk.userservice.utils;
...
public class JwtOperator {
     ...
     * 秘钥
     */
    @Value("${secret:aaaaaaaaaabbbbbbbbbbbcccccccccccdddddddd}")
    ...
    public static void main(String[] args) {
        ...
        jwtOperator.secret = "aaaaaaaaaabbbbbbbbbbbcccccccccccdddddddd";
        //jwtOperator.secret = "abc123";

        // 2.设置用户信息
        HashMap<String, Object> objectObjectHashMap = Maps.newHashMap();
        objectObjectHashMap.put("mobile", "13913457284");
        objectObjectHashMap.put("password", "123123");
...
//         测试1: 生成token
        ...
        // 将这串字符还原为上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJyb2xlcyI6ImFkbWluIiwiaWQiOjQsImlhdCI6MTY2NDg4NDEyNywiZXhwIjoxNjY2MDkzNzI3fQ.hwfTmTf7eCcjn-LdOTItCAaqtwdZq550zvE6MbsZ0S0";
