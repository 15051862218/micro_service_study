...
import com.syk.contentservice.utils.JwtOperator;
...
public class AuthAspect {
    ...
    @Around(value = "@annotation(com.syk.contentservice.auth.CheckLogin)")
    public Object checkLogin(ProceedingJoinPoint point) throws  Throwable {
        checkToken();;
        //使用反射去调用目标方法
        return point.proceed();
    }
    @Around(value = "@annotation(com.syk.contentservice.auth.CheckAuthorization)")
